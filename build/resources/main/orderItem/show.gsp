...
<html>
    ...
    <body>
        ...
        <div id="show-orderItem" class="content scaffold-show" role="main">
            ...
            <f:display bean="orderItem" />
            <g:form resource="${this.orderItem}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.orderItem}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
