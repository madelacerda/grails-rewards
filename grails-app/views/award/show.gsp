...
<html>
    ...
    <body>
        ...
        <div id="show-award" class="content scaffold-show" role="main">
            ...
            <f:display bean="award" />
            <g:form resource="${this.award}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.award}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
